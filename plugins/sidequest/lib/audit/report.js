...
function gitExecutor(cwd) {
  return (args) => {
    try {
      return String((0, import_node_child_process.execFileSync)("git", args, { cwd, encoding: "utf8", stdio: ["ignore", "pipe", "ignore"], windowsHide: true }));
    } catch (_) {
      return null;
    }
  };
...
function ghExecutor() {
  return (program, arguments_, options = {}) => (0, import_node_child_process.execFileSync)(program, arguments_, options);
}
