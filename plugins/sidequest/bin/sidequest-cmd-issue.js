...
async function cmdIssue(opts, positional) {
  ...
  const result = action === "link" ? store.addExternalLink(project.slug, ref, issue) : store.removeExternalLink(project.slug, ref, issue);
